...
if 'error' in st.session_state:
    ...
    try:
        response = replicate_llm.invoke(prompt)  # Directly call the model with the prompt
        st.session_state.coaching_report = response  # Save the response in session state
